## [1.11.0](https://github.com/Mearman/hobby.ninja/compare/v1.10.0...v1.11.0) (2026-01-04)

### Features

- **eslint:** add Next.js and Storybook ESLint plugins ([d8a9569](https://github.com/Mearman/hobby.ninja/commit/d8a9569f990c7ac166564226a0985d54c9d012ec))
- **next:** add @storybook/addon-docs for documentation ([8756711](https://github.com/Mearman/hobby.ninja/commit/87567118ccfc3c4e50e1607e5d6841bb6814e5c7))
- **next:** add badge images and counts to quick filter presets ([6032c4d](https://github.com/Mearman/hobby.ninja/commit/6032c4d0bd25bef869deee16c0cac6fbe6b8971e))
- **next:** add filter context with URL state persistence ([2346079](https://github.com/Mearman/hobby.ninja/commit/234607972b2fce516152ae19cf0684edb36936b5))
- **next:** add FilterUsage table to Dexie database ([a177825](https://github.com/Mearman/hobby.ninja/commit/a1778255e4279b8fa65fc4a32eee94f3b09eb611))
- **next:** add HeaderAction component for header buttons ([65e9557](https://github.com/Mearman/hobby.ninja/commit/65e95571d56b6ac42380d93c334d07f8fe09d6d2))
- **next:** add hierarchical expand/collapse for grades in sidebar ([53013f4](https://github.com/Mearman/hobby.ninja/commit/53013f4978cca7678d0919b1b91507b01e99028d))
- **next:** add maxFontSize prop to FittedText for compact text ([949081c](https://github.com/Mearman/hobby.ninja/commit/949081c87c014b93e8776ed0a5bd69a43d4f4ecd))
- **next:** add mobile-friendly sidebar filter UI ([12b7c5c](https://github.com/Mearman/hobby.ninja/commit/12b7c5c24c4b41ab801ea7c509f6b9d7df285013))
- **next:** add navigation utility functions ([a43ec94](https://github.com/Mearman/hobby.ninja/commit/a43ec94c71e11fc195902105856b513650868fd7))
- **next:** add pinnable sidebar on desktop screens ([19f85ae](https://github.com/Mearman/hobby.ninja/commit/19f85aeb74a65cabbd55cad75c85242471cec945))
- **next:** add portal support to YearScrollbar for container mode ([25e8629](https://github.com/Mearman/hobby.ninja/commit/25e86291bb270df3981e362410787472d1196ab5))
- **next:** add resize handle to unpinned drawer on desktop ([177d359](https://github.com/Mearman/hobby.ninja/commit/177d359a14db5e99592e5b70fbac250b8c62b854))
- **next:** add ResizeHandle component for resizable sidebar ([a38846b](https://github.com/Mearman/hobby.ninja/commit/a38846b03a26837b43093336175c6c3f507312c8))
- **next:** add scroll container context for injectable scroll tracking ([1815bd3](https://github.com/Mearman/hobby.ninja/commit/1815bd303a1c1f79c86df975308c4e6aa79955dd))
- **next:** add separate tsconfig for Storybook typechecking ([e46a9c7](https://github.com/Mearman/hobby.ninja/commit/e46a9c740f0df6a37e3bab6f3a62ffd471e77984))
- **next:** add sidebarWidth state with localStorage persistence ([972dad8](https://github.com/Mearman/hobby.ninja/commit/972dad85704baf6014f99ee79af13b98410c8785))
- **next:** add sort toggle and select all/none to sidebar filters ([58b23a3](https://github.com/Mearman/hobby.ninja/commit/58b23a357713fd109f7effb2f3a307fa9b9cf12c))
- **next:** add Storybook 10 with multi-device preview ([9c6f009](https://github.com/Mearman/hobby.ninja/commit/9c6f009bd58fc44278a2ae8a70b415de1c0527a3))
- **next:** add unified navigation configuration ([90c8d1b](https://github.com/Mearman/hobby.ninja/commit/90c8d1b54711f58fd9a5d4532a2cbda72e81ec6f))
- **next:** display dynamic quick filters based on usage ([e9c401d](https://github.com/Mearman/hobby.ninja/commit/e9c401d787eca1c39f3fd2956db4b81df31f3991))
- **next:** implement auto-sizing grid layout for sidebar filter buttons ([d3def20](https://github.com/Mearman/hobby.ninja/commit/d3def20692a22e8e891347232da1fc01c636958e))
- **next:** integrate sidebar filters into navigation drawer ([9196a76](https://github.com/Mearman/hobby.ninja/commit/9196a762402c668a48dc670085d869b832aa9fc8))
- **next:** sync homepage filters with sidebar via context ([6524a24](https://github.com/Mearman/hobby.ninja/commit/6524a249e7db093b47b351a2c3a7ab55d06678c7))
- **next:** track filter usage in filter context ([8257c63](https://github.com/Mearman/hobby.ninja/commit/8257c63da34981e27f870d5764f8c7231d17de0e))
- **next:** use dynamic sidebarWidth from theme context ([5c87e19](https://github.com/Mearman/hobby.ninja/commit/5c87e19ee233f97ee4777c0733d7346698be9546))
- **next:** use resized width for unpinned drawer on desktop ([5371757](https://github.com/Mearman/hobby.ninja/commit/537175788240c27393d41b72de72e14fafe5e129))
- **next:** wrap app with FilterProvider for global filter state ([c7918f3](https://github.com/Mearman/hobby.ninja/commit/c7918f3f6181c745a38df543240468e7495bbd3d))
- **nx:** integrate @nx/storybook plugin ([f87ae5b](https://github.com/Mearman/hobby.ninja/commit/f87ae5b307d6a8b73768d1ab4d860f33f84ef36b))
- **storybook:** add fixed layer for portal-based positioning ([042312a](https://github.com/Mearman/hobby.ninja/commit/042312a9a5b3cfa1767a662e5737ddb215582d07))
- **storybook:** add homepage stories with header at multiple device sizes ([b5eef0a](https://github.com/Mearman/hobby.ninja/commit/b5eef0a036fecd0d3774971876fd8a44ed23d62c))
- **storybook:** add Homepage story with sampled real data ([daed712](https://github.com/Mearman/hobby.ninja/commit/daed7124147448f3e08d9ff2ed9c58f6dd22e80d))
- **storybook:** add SideBySideThemes decorator for theme comparison ([a92023c](https://github.com/Mearman/hobby.ninja/commit/a92023c90c138b1957aab70fb2eb2881ef835ce4))
- **storybook:** add SingleViewContainer decorator for proper YearScrollbar positioning ([398d5e3](https://github.com/Mearman/hobby.ninja/commit/398d5e30a7e198c88fbe372456bc7eecb4064edd))
- **storybook:** add theme toolbar with light/dark/system options ([588fffb](https://github.com/Mearman/hobby.ninja/commit/588fffbd2870bf51239627966c8c0d6e72aa9b17))
- **storybook:** add theme variant stories for Homepage ([babb8f9](https://github.com/Mearman/hobby.ninja/commit/babb8f97ecc130e85d6ae36020f8d74f0ffd7db6))
- **storybook:** add ThemeWrapper decorator for theme switching ([ea654bd](https://github.com/Mearman/hobby.ninja/commit/ea654bd0ef978ae80b3172ce25b65c345d19ab74))

### Bug Fixes

- **ci:** disable TypeScript project for Storybook files in ESLint ([6646f8d](https://github.com/Mearman/hobby.ninja/commit/6646f8dda742459ec4ccbbf896c8406836e9d4aa))
- **ci:** exclude Storybook files from ESLint entirely ([75a5c08](https://github.com/Mearman/hobby.ninja/commit/75a5c08263d3528171ec321ad4083516c391b005))
- **ci:** exclude Storybook files from ESLint lint target ([432952f](https://github.com/Mearman/hobby.ninja/commit/432952f7f84834a7ec151df309306c84c59b7656))
- **ci:** fix pre-existing ESLint errors in other packages ([1a1109e](https://github.com/Mearman/hobby.ninja/commit/1a1109e365f764517ccf645dc66004563d10d7f9))
- **ci:** fix tseslint disableTypeChecked usage ([688195c](https://github.com/Mearman/hobby.ninja/commit/688195ce97a762e1a4d111fb120e805160faecc7))
- **ci:** use tseslint disableTypeChecked for Storybook files ([1b3cf4b](https://github.com/Mearman/hobby.ninja/commit/1b3cf4b25a8ab5138dd249edb0f6cc761a61f4f5))
- **next:** add scrollbar padding only in full width mode ([d1e4690](https://github.com/Mearman/hobby.ninja/commit/d1e4690c9af85309c73c2363f0072a70ec05cdd0))
- **next:** add SSR-safe initial value to useMediaQuery for sidebar ([8f29e84](https://github.com/Mearman/hobby.ninja/commit/8f29e84d4b244d28795dc11fa5fec33dc352bf65))
- **next:** align scrollbar padding with actual YearScrollbar dimensions ([d243fc3](https://github.com/Mearman/hobby.ninja/commit/d243fc3c3e945c27b1929b66b4a0243a459168ca))
- **next:** always apply scrollbar padding to main content ([109293d](https://github.com/Mearman/hobby.ninja/commit/109293daffb28dba7acc532aab7a7278472f8525))
- **next:** click parent grade card to expand/collapse children ([aedd3c9](https://github.com/Mearman/hobby.ninja/commit/aedd3c994cf5e2288050c16dae8ec35662db01d7))
- **next:** correct sort toggle icons and behavior in sidebar filters ([f324183](https://github.com/Mearman/hobby.ninja/commit/f324183cc854a1a05a5018ba727d6d369eb8e1b7))
- **next:** enable scroll in navigation drawer on mobile ([f19967b](https://github.com/Mearman/hobby.ninja/commit/f19967b1dac0e7a49af5a0d5eff4d0834a00a7c7))
- **next:** extend FittedText font sizes down to 6px for very long labels ([3407ae2](https://github.com/Mearman/hobby.ninja/commit/3407ae231ceff2d193ac0084975f43603d6c3af7))
- **next:** force reflow after fontSize change in FittedText ([5a9c248](https://github.com/Mearman/hobby.ninja/commit/5a9c248b8065bd755900b91b497657e58ab52951))
- **next:** hide header items on mobile for cleaner layout ([4e42cb6](https://github.com/Mearman/hobby.ninja/commit/4e42cb6bc7ac2145c216d0259c0201c0f98664d7))
- **next:** hide YearScrollbar in full width mode ([5499042](https://github.com/Mearman/hobby.ninja/commit/5499042fa3f9d9700dee28768b9bb996346b2cf6))
- **next:** improve quick filter responsiveness and sizing ([cc37268](https://github.com/Mearman/hobby.ninja/commit/cc37268cffa865c8c61b00eac70360cc5905c65d))
- **next:** improve text scaling for long labels in sidebar filters ([5bc40f5](https://github.com/Mearman/hobby.ninja/commit/5bc40f534d5aa90d69d842463afa502b0fbdee63))
- **next:** make entire filter section header row clickable ([51c1997](https://github.com/Mearman/hobby.ninja/commit/51c199735360fc95800daa535ca1d504cb0a0aad))
- **next:** preserve original sort order for scales and years in sidebar ([e8b3aa3](https://github.com/Mearman/hobby.ninja/commit/e8b3aa31c16828772e09ea4a2840cb1039128a35))
- **next:** reduce FittedText padding from 12px to 4px ([a83e270](https://github.com/Mearman/hobby.ninja/commit/a83e270772958cbdcc69386af511b1231903955b))
- **next:** remove Container right padding when scrollbar padding applied ([6933b17](https://github.com/Mearman/hobby.ninja/commit/6933b17b86fa94145e27ec6c13375016941a6809))
- **next:** remove Database from navigation sidebar ([54b6ed5](https://github.com/Mearman/hobby.ninja/commit/54b6ed5af82d41fff419398b2efcca762ef231f4))
- **next:** remove scrollbar padding from header entirely ([e022d18](https://github.com/Mearman/hobby.ninja/commit/e022d18338b595553d8269d7649570e621a162f7))
- **next:** remove scrollbar padding from HomepageClient ([9769fc9](https://github.com/Mearman/hobby.ninja/commit/9769fc93896d0580c11bc6ccf3b837ea63eecd19))
- **next:** remove scrollbar padding on mobile header ([dfcf483](https://github.com/Mearman/hobby.ninja/commit/dfcf4834d564a27db1b93b662f94ace5af229ad6))
- **next:** remove scrollbar padding on xl screens in constrained mode ([e0787af](https://github.com/Mearman/hobby.ninja/commit/e0787af7a2bdb50e07bea8376dad0fa511452199))
- **next:** resolve nested button hydration error ([daccb28](https://github.com/Mearman/hobby.ninja/commit/daccb28511ea283e06d8dea99d2ae5c816588b93))
- **next:** resolve pin button visibility in sidebar drawer ([c09807a](https://github.com/Mearman/hobby.ninja/commit/c09807aa07027fc8d9d4c979e9c121debb5f9f05))
- **next:** select root grade when clicked in addition to expand ([696656c](https://github.com/Mearman/hobby.ninja/commit/696656cd48337241e1d75f5c3a3e1dbd19392273))
- **next:** show all grades including sub-grades in sidebar filters ([5e83687](https://github.com/Mearman/hobby.ninja/commit/5e836874c5e3056f27759d5dfdde42c5a3117623))
- **next:** show grade children inline after parent in grid ([d05da63](https://github.com/Mearman/hobby.ninja/commit/d05da6303c093679446831912949f7510d1e8971))
- **next:** simplify header scrollbar padding using Container pr prop ([3f60475](https://github.com/Mearman/hobby.ninja/commit/3f604751d7efdd323043c44e612a4a2aa7d9a3b5))
- **next:** use filter context as single source of truth ([bab8051](https://github.com/Mearman/hobby.ninja/commit/bab80519f1dc40c036d6d1fd3c6a680d0f3dd2d4))
- **next:** use flex grid layout for parent grades in sidebar ([01c1af9](https://github.com/Mearman/hobby.ninja/commit/01c1af905ac39d105303be7d3cdf392af64bebf0))
- **next:** use globalThis.window for proper type compatibility in YearScrollbar ([28b50ed](https://github.com/Mearman/hobby.ninja/commit/28b50ed9e394e49eb2f1faa2f5a34ff659c12415))
- **next:** wrap FilterProvider children in Suspense for useSearchParams ([6cda5f2](https://github.com/Mearman/hobby.ninja/commit/6cda5f2adfbc86925e82a83d535799c4725b741b))
- **next:** wrap FilterProvider in Suspense boundary at layout level ([35769ea](https://github.com/Mearman/hobby.ninja/commit/35769ea1e5426e7ce4d5aa2d2f5dc55f244b2366))
- **storybook:** add data-mantine-color-scheme for component styling ([9b82c92](https://github.com/Mearman/hobby.ninja/commit/9b82c92056258d1d6479616e9d258c4ce1cf66d3))
- **storybook:** add mobile menu state and Navigation to header stories ([e3216c0](https://github.com/Mearman/hobby.ninja/commit/e3216c0df6a4cd11dc458c5384590f267b38d24d))
- **storybook:** load Inter font and carousel styles ([e4c6f22](https://github.com/Mearman/hobby.ninja/commit/e4c6f2272403aa5e566364f1c08f4827f16eb0f0))
- **storybook:** set data-mantine-color-scheme for theme switching ([a8169de](https://github.com/Mearman/hobby.ninja/commit/a8169de026bb9c500732b7f4486d0e0582e4305f))
- **storybook:** update viewport config for Storybook 10 ([36bf4a0](https://github.com/Mearman/hobby.ninja/commit/36bf4a03997f78c9607d07a52e32863d59aa487c))
- **storybook:** use Mantine CSS variable for theme background color ([56fd43d](https://github.com/Mearman/hobby.ninja/commit/56fd43dd127ad67e373831eaaf87e52a187f7720))
- **storybook:** use scoped class selectors for side-by-side themes ([9640dbc](https://github.com/Mearman/hobby.ninja/commit/9640dbcc1546bfc0dc8e8dbe1354bb62b24261a0))

### Refactoring

- **next:** export ThemeContext for Storybook compatibility ([3326553](https://github.com/Mearman/hobby.ninja/commit/3326553cdeaca076c14e046728a829730174475a))
- **next:** remove Explore header from homepage ([bfe8f7d](https://github.com/Mearman/hobby.ninja/commit/bfe8f7dd73f6c60aab3668d64d6bee725b1140b8))
- **next:** remove inline filter sections from homepage body ([4f26d58](https://github.com/Mearman/hobby.ninja/commit/4f26d58829df1634824c955c46d336d467b716b9))
- **next:** remove more/less toggle from sidebar filters ([ed1f0a8](https://github.com/Mearman/hobby.ninja/commit/ed1f0a896a9e6787c98ed96cc02f6667f4586ab5))
- **next:** simplify sidebar to show header actions only ([22e6a87](https://github.com/Mearman/hobby.ninja/commit/22e6a8793a3f42b80de253a211679b3bc77e3d2d))
- **next:** use shared navigation config in header ([39a7744](https://github.com/Mearman/hobby.ninja/commit/39a77449d581fd29ba36cf4a085437b5c26af205))
- **storybook:** use next/font instead of CDN workaround ([171980d](https://github.com/Mearman/hobby.ninja/commit/171980d9724627716de27a6943b38b74c0cea079))

### Documentation

- **next:** update quick filters section label ([c245aca](https://github.com/Mearman/hobby.ninja/commit/c245aca56d0ce805ba2f854930df6664c8d25f87))

### Chores

- **deps:** update workspace package dependencies ([9578cb9](https://github.com/Mearman/hobby.ninja/commit/9578cb95480c736e63078274c7f90d03042ae905))
