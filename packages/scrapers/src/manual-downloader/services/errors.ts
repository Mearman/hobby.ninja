...
export class NetworkError extends ManualDownloaderError {
  constructor(code: string, message: string, recoverable: boolean = true) {
...
export class FileSystemError extends ManualDownloaderError {
  ...
  constructor(code: string, message: string, filePath?: string, recoverable: boolean = false) {
...
export class ErrorFactory {
   ...
   */
  static network(code: string, message: string, recoverable: boolean = true): NetworkError {
   ...
   * Create HTTP error
   */
  static http(code: string, message: string, statusCode?: number, statusText?: string): HttpError {
   ...
   */
  static filesystem(code: string, message: string, filePath?: string, recoverable: boolean = false): FileSystemError {
   ...
   */
  static validation(code: string, message: string, field?: string, value?: any): ValidationError {
   ...
   */
  static configuration(code: string, message: string, configKey?: string): ConfigurationError {
   ...
   */
  static process(error: unknown, context?: string): ErrorInfo {
   ...
   */
  static fromUnknown(error: unknown, context?: string): ManualDownloaderError {
...
export class ErrorHandler {
   ...
   */
  static getSuggestion(error: unknown): string | undefined {
    const errorInfo = this.process(error);
