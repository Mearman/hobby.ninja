...
export class FileManager {
   ...
   */
  static async ensureOutputDirectory(dirPath: string): Promise<void> {
    try {
   ...
   */
  static async writeFileAtomic(filePath: string, data: string): Promise<void> {
   ...
   */
  static async initializeOutput(outputDirectory: string): Promise<void> {
   ...
   */
  static async appendResult(outputDirectory: string, result: ScanResult): Promise<void> {
    const resultsFile = path.join(outputDirectory, 'scan-results.json');
   ...
   */
  static async readProgress(filePath: string): Promise<ProgressState | null> {
    try {
   ...
   */
  static async writeProgress(filePath: string, progress: ProgressState): Promise<void> {
