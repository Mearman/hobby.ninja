...
const errorMap = new Map<ErrorCode, ErrorInfo>();
...
function registerDefaultErrors(): void {
	// Configuration errors
	register(ErrorCode.CONFIG_FILE_NOT_FOUND, ErrorCategory.CONFIGURATION,
	...
	register(ErrorCode.CONFIG_INVALID_FORMAT, ErrorCategory.CONFIGURATION,
	...
	register(ErrorCode.CONFIG_VALIDATION_FAILED, ErrorCategory.CONFIGURATION,
	...
	// Network errors
	register(ErrorCode.NETWORK_CONNECTION_FAILED, ErrorCategory.NETWORK,
	...
	register(ErrorCode.NETWORK_TIMEOUT, ErrorCategory.NETWORK,
	...
	register(ErrorCode.NETWORK_DNS_RESOLUTION, ErrorCategory.NETWORK,
	...
	// Scraping errors
	register(ErrorCode.SCRAPE_PAGE_NOT_FOUND, ErrorCategory.SCRAPING,
	...
	register(ErrorCode.SCRAPE_ACCESS_DENIED, ErrorCategory.SCRAPING,
		"Access denied (403)",
	...
	register(ErrorCode.SCRAPE_RATE_LIMITED, ErrorCategory.SCRAPING,
	...
	register(ErrorCode.SCRAPE_STRUCTURE_CHANGED, ErrorCategory.SCRAPING,
	...
	// Data errors
	register(ErrorCode.DATA_EXTRACTION_FAILED, ErrorCategory.DATA,
	...
	register(ErrorCode.DATA_VALIDATION_FAILED, ErrorCategory.DATA,
	...
	// Filesystem errors
	register(ErrorCode.FS_FILE_NOT_FOUND, ErrorCategory.FILESYSTEM,
	...
	register(ErrorCode.FS_PERMISSION_DENIED, ErrorCategory.FILESYSTEM,
	...
	register(ErrorCode.FS_DISK_FULL, ErrorCategory.FILESYSTEM,
	...
	register(ErrorCode.RATE_LIMIT_EXCEEDED, ErrorCategory.RATE_LIMIT,
...
export const ErrorRegistry = {
	getErrorInfo(code: ErrorCode): ErrorInfo | undefined {
	...
	registerCustom(errorInfo: ErrorInfo): void {
		errorMap.set(errorInfo.code, errorInfo);
	},
};
