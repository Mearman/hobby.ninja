...
program
	...
	.option("--manuals-dir <dir>", "Output directory for manual assets", "./assets/manuals")
	.option("--catalog-dir <dir>", "Catalog data directory", "./data/src/items")
	.option("--catalog-images-dir <dir>", "Output directory for catalog images", "./assets/images/items")
