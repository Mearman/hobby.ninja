...
export class ErrorHandler {
  ...
  static createParsingError(message: string, url?: string, context?: Record<string, any>): ScraperError {
    return new ErrorHandler().createError(
      message,
  ...
  static createValidationError(message: string, context?: Record<string, any>): ScraperError {
    return new ErrorHandler().createError(
      message,
  ...
  static createConfigurationError(message: string, context?: Record<string, any>): ScraperError {
    return new ErrorHandler().createError(
      message,
