...
export const DEFAULT_TIMEOUTS = {
  ...
  DEFAULT_DELAY: 2_000,   // 2 seconds default between requests
...
export const RETRY_CONFIG = {
  ...
  MAX_RETRIES: 10,
  MIN_RETRIES: 0,
  RETRY_DELAY_BASE: 1_000, // Base delay for exponential backoff
} as const;
...
export const PROGRESS_PERCENTAGES = {
  ...
  COMPLETE_PROGRESS: 1.0, // 100% for complete
} as const;

// Cache and storage constants
export const CACHE_CONFIG = {
  DEFAULT_TTL_HOURS: 24,
  DEFAULT_TTL_MILLISECONDS: 24 * 60 * 60 * 1_000, // 24 hours
  MIN_TTL_HOURS: 1,
  MAX_TTL_HOURS: 168, // 1 week
  DEFAULT_CACHE_DIR: '.cache/gundam-scraper',
  COMPRESSION_THRESHOLD: 1_024, // Compress files larger than 1KB
} as const;
...
export const RATE_LIMITING = {
  ...
  DEFAULT_REQUESTS_PER_HOUR: 1_000,
