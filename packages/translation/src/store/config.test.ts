...
describe('config', () => {
	...
	describe('validateConfig', () => {
		...
		it('should generate warnings for potentially problematic configurations', () => {
			const config = {
				storagePath: '.gundam-cache/translations',
				maxEntries: 200000, // Large number - should trigger warning
				maxSizeBytes: 100 * 1024 * 1024,
				compressionThreshold: 1024,
				memoryCacheSize: 150000, // > 50% of maxEntries - should trigger warning
	...
	describe('CONFIGURATION_PRESETS', () => {
		...
		it('should have valid preset configurations', () => {
			Object.values(CONFIGURATION_PRESETS).forEach(preset => {
