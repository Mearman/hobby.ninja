 ...
 */
export function transformEdgesToUltraCompact(edges: UnifiedEdge[]): UltraCompactEdgeMap {
 ...
 */
export function convertFromUltraCompact(ultraCompactMap: UltraCompactEdgeMap): UnifiedEdge[] {
