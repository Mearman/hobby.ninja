            ...
            {stats && (
              <>
                ...
                <MultiSelect
                  ...
                  data={stats.brands.map((brand: string) => ({
                    value: brand,
                    label: brand,
                  }))}
                ...
                <MultiSelect
                  ...
                  data={stats.categories.map((category: string) => ({
                    value: category,
                    label: category,
                  }))}
                ...
                <MultiSelect
                  ...
                  data={stats.series.map((series: string) => ({
                    value: series,
                    label: series,
                  }))}
                ...
                <MultiSelect
                  ...
                  data={stats.grades.map((grade: string) => ({
                    value: grade,
                    label: grade,
                  }))}
                ...
                <MultiSelect
                  ...
                  data={stats.scales.map((scale: string) => ({
                    value: scale,
                    label: scale,
                  }))}
