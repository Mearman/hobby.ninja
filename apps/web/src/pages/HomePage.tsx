  ...
  return (
    <div className={homeContainer}>
      <Container size="lg">
        ...
        {/* Stats Section */}
        <Card p="xl" radius="md" mb="3rem" withBorder>
        ...
        {/* Quick Start Section */}
        <Card p="xl" radius="md" mt="3rem" withBorder>
          <Title order={2} mb="lg" ta="center">
            Quick Start
          </Title>
          <Grid>
            <Grid.Col span={{ base: 12, md: 6 }}>
              <div style={{ textAlign: 'center' }}>
                ...
                <Button component={Link} to="#/database" variant="outline" fullWidth>
                  Browse Database
                </Button>
              </div>
            </Grid.Col>
            <Grid.Col span={{ base: 12, md: 6 }}>
              <div style={{ textAlign: 'center' }}>
                ...
                <Button component={Link} to="#/collection" variant="outline" fullWidth>
                  Manage Collection
                </Button>
              </div>
            </Grid.Col>
